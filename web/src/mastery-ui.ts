...
type Copy = {
  ...
  rewards: string; badge: string; title: string; frame: string; none: string; equip: string; explorer: string; completeFrame: string;
...
const EN_NAMES: Record<MasteryId, string> = { M01: "First Victory", M02: "Six Kinds of Feel", M03: "Problem Solver", M04: "Precise Solution", M05: "Sense of the Match", M06: "Double Out", M07: "Everyone Returned", M08: "Terrain Explorer" };
...
const EN_TIPS: Record<MasteryId, string> = { M01: "Play Stage Battle and finish the opponent.", M02: "Try the tutorial, PVE, or official puzzles.", M03: "Open Official Puzzles and solve new problems.", M04: "Replay official puzzles while meeting their gold rules.", M05: "Keep progressing through Stage Battle.", M06: "Look for chain shots in PVE or official puzzles.", M07: "Use controlled shots and protect every friendly piece.", M08: "Advance through stages to discover new terrain." };

const BASE: Omit<Copy, "names" | "conditions" | "tips"> = {
  book: "Mastery Medal Book", summary: "Mastery", personal: "Personal record", experience: "Experience", skill: "Skill", complete: "Earned", locked: "In progress",
  track: "Track objective", tracking: "Tracked", untrack: "Stop tracking", details: "Condition details", modes: "Eligible modes", reward: "Reward", play: "Recommended play", close: "Close",
  rewards: "Rewards & equipment", badge: "Badge", title: "Title", frame: "Profile frame", none: "None", equip: "Equip", explorer: "Explorer", completeFrame: "Mastery Complete frame",
  future: "Woodgrain set entitlement — cosmetic scheduled for a future release.", pending: "New mastery records await server storage and are safe in this account's device cache.",
  malformed: "Mastery data needs recovery. New writes are paused to preserve it.", result: "Mastery progress", viewAll: "View All",
};

const localized: Partial<Record<LanguageCode, Partial<Copy>>> = {
  ko: {
    book: "숙련 메달 도감", summary: "숙련", personal: "개인 기록", experience: "경험", skill: "기술", complete: "획득", locked: "진행 중", track: "목표 추적", tracking: "추적 중", untrack: "추적 해제", details: "조건 상세", modes: "인정 모드", reward: "보상", play: "추천 플레이", close: "닫기", rewards: "보상 및 장착", badge: "배지", title: "칭호", frame: "프로필 프레임", none: "없음", equip: "장착", explorer: "탐구자", completeFrame: "숙련 완성 프레임", future: "나뭇결 세트 이용권 — 꾸미기 아이템은 향후 출시 예정입니다.", pending: "새 숙련 기록이 서버 저장을 기다리며 이 계정의 기기 캐시에 안전하게 보관됩니다.", malformed: "숙련 기록 복구가 필요하여 원본 보존을 위해 새 저장을 멈췄습니다.", result: "숙련 진행", viewAll: "전체 보기",
  ...
  ja: { book: "熟練メダルブック", summary: "熟練", personal: "個人記録", experience: "経験", skill: "技術", complete: "獲得済み", locked: "進行中", track: "目標を追跡", tracking: "追跡中", untrack: "追跡解除", details: "条件詳細", modes: "対象モード", reward: "報酬", play: "おすすめプレイ", close: "閉じる", rewards: "報酬と装備", badge: "バッジ", title: "称号", frame: "プロフィールフレーム", none: "なし", equip: "装備", explorer: "探究者", future: "木目セット権利 — コスメは今後リリース予定です。", result: "熟練進行", viewAll: "すべて表示",
  ...
  "zh-CN": { book: "精通勋章册", summary: "精通", personal: "个人记录", experience: "经验", skill: "技巧", complete: "已获得", locked: "进行中", track: "追踪目标", tracking: "追踪中", untrack: "停止追踪", details: "条件详情", modes: "适用模式", reward: "奖励", play: "推荐玩法", close: "关闭", rewards: "奖励与装备", badge: "徽章", title: "称号", frame: "头像框", none: "无", equip: "装备", explorer: "探索者", future: "木纹套装权益 — 外观内容计划未来推出。", result: "精通进度", viewAll: "查看全部",
  ...
  de: { book: "Meisterschaftsmedaillen", summary: "Meisterschaft", personal: "Persönlicher Rekord", experience: "Erfahrung", skill: "Fertigkeit", complete: "Verdient", locked: "In Arbeit", track: "Ziel verfolgen", tracking: "Verfolgt", untrack: "Nicht mehr verfolgen", details: "Bedingungen", modes: "Gültige Modi", reward: "Belohnung", play: "Empfohlen", close: "Schließen", rewards: "Belohnungen & Ausrüstung", badge: "Abzeichen", title: "Titel", frame: "Profilrahmen", none: "Keine", equip: "Ausrüsten", explorer: "Entdecker", future: "Holzmaserungs-Set-Berechtigung — Kosmetik erscheint später.", result: "Meisterschaftsfortschritt", viewAll: "Alle anzeigen",
  ...
  fr: { book: "Livre des médailles", summary: "Maîtrise", personal: "Record personnel", experience: "Expérience", skill: "Technique", complete: "Obtenue", locked: "En cours", track: "Suivre l’objectif", tracking: "Suivi", untrack: "Arrêter le suivi", details: "Conditions", modes: "Modes éligibles", reward: "Récompense", play: "Jeu conseillé", close: "Fermer", rewards: "Récompenses et équipement", badge: "Badge", title: "Titre", frame: "Cadre de profil", none: "Aucun", equip: "Équiper", explorer: "Explorateur", future: "Droit au set bois — cosmétique prévu pour une sortie future.", result: "Progression de maîtrise", viewAll: "Tout voir",
  ...
  es: { book: "Libro de medallas", summary: "Maestría", personal: "Récord personal", experience: "Experiencia", skill: "Técnica", complete: "Obtenida", locked: "En progreso", track: "Seguir objetivo", tracking: "Siguiendo", untrack: "Dejar de seguir", details: "Condiciones", modes: "Modos válidos", reward: "Recompensa", play: "Juego recomendado", close: "Cerrar", rewards: "Recompensas y equipo", badge: "Insignia", title: "Título", frame: "Marco de perfil", none: "Ninguno", equip: "Equipar", explorer: "Explorador", future: "Derecho al set de madera — cosmético previsto para el futuro.", result: "Progreso de maestría", viewAll: "Ver todo",
  ...
  ru: { book: "Книга медалей мастерства", summary: "Мастерство", personal: "Личный рекорд", experience: "Опыт", skill: "Навык", complete: "Получено", locked: "В процессе", track: "Отслеживать", tracking: "Отслеживается", untrack: "Не отслеживать", details: "Условия", modes: "Доступные режимы", reward: "Награда", play: "Рекомендуемая игра", close: "Закрыть", rewards: "Награды и снаряжение", badge: "Значок", title: "Титул", frame: "Рамка профиля", none: "Нет", equip: "Надеть", explorer: "Исследователь", future: "Право на набор «Дерево» — косметика выйдет позже.", result: "Прогресс мастерства", viewAll: "Показать все",
  ...
  "pt-BR": { book: "Livro de medalhas", summary: "Maestria", personal: "Recorde pessoal", experience: "Experiência", skill: "Técnica", complete: "Obtida", locked: "Em progresso", track: "Acompanhar objetivo", tracking: "Acompanhando", untrack: "Parar de acompanhar", details: "Condições", modes: "Modos válidos", reward: "Recompensa", play: "Jogo recomendado", close: "Fechar", rewards: "Recompensas e equipamento", badge: "Distintivo", title: "Título", frame: "Moldura de perfil", none: "Nenhum", equip: "Equipar", explorer: "Explorador", future: "Direito ao conjunto amadeirado — cosmético previsto para o futuro.", result: "Progresso de maestria", viewAll: "Ver tudo",
...
const localizedStates: Partial<Record<LanguageCode, Pick<Copy, "completeFrame" | "pending" | "malformed">>> = {
  ko: {
    completeFrame: "숙련 완성 프레임",
    pending: "새 숙련 기록은 서버 저장을 기다리는 동안 이 계정의 기기 캐시에 안전하게 보관됩니다.",
    malformed: "숙련 기록 복구가 필요합니다. 데이터를 보호하기 위해 새 저장을 멈췄습니다.",
  },
  ja: {
    completeFrame: "熟練達成フレーム",
    pending: "新しい熟練記録はサーバー保存待ちで、この端末のアカウントキャッシュに安全に保持されています。",
    malformed: "熟練データの復旧が必要です。保護のため新しい保存を停止しました。",
  },
  "zh-CN": {
    completeFrame: "熟练完成头像框",
    pending: "新的熟练记录正在等待服务器存储，并安全保存在此设备的账户缓存中。",
    malformed: "熟练数据需要恢复。为保护数据，已暂停写入。",
  },
  de: {
    completeFrame: "Meisterschaftsrahmen",
  ...
  fr: {
    completeFrame: "Cadre Maîtrise accomplie",
  ...
  es: {
    completeFrame: "Marco Maestría completa",
  ...
  ru: {
    completeFrame: "Рамка «Мастерство»",
  ...
  "pt-BR": {
    completeFrame: "Moldura Maestria completa",
...
export function masteryCopy(): Copy {
  ...
  return { ...BASE, names: EN_NAMES, conditions: EN_CONDITIONS, tips: EN_TIPS, ...override, ...localizedStates[language] } as Copy;
}

function rewardLabel(id: MasteryId): string { return `${masteryCopy().badge} · ${id}`; }
function modeLabel(mode: string): string { return I18nManager.t(mode === "stage" ? "lobby.mode_stage_short" : mode === "tutorial" ? "lobby.footer_tutorial" : "lobby.mode_puzzle"); }
export function renderMasteryProfileSummary(storage: MasteryStorage): string {
  const snapshot = loadMasterySnapshot(storage); const copy = masteryCopy(); const count = earnedMedalCount(snapshot.progress);
  const title = equippedItem(snapshot, "title") === "title:explorer" ? copy.explorer : "";
  const badge = equippedItem(snapshot, "badge"); const frame = equippedItem(snapshot, "frame");
...
function medalCard(storage: MasteryStorage, id: MasteryId): string {
  const snapshot = loadMasterySnapshot(storage); const copy = masteryCopy(); const def = MASTERY_DEFINITIONS.find(item => item.id === id)!;
  const value = medalProgress(snapshot.progress, id); const earned = isMedalEarned(snapshot.progress, id); const tracked = snapshot.preferences.tracked.medalId === id;
...
function ownedOptions(storage: MasteryStorage, slot: EquipmentSlot): string {
  const snapshot = loadMasterySnapshot(storage); const copy = masteryCopy(); const equipped = equippedItem(snapshot, slot);
...
export function openMasteryBook(container: HTMLElement, storage: MasteryStorage, onRoute: (id: MasteryId) => void, onChanged?: () => void): void {
  ...
  const openerSelector = previousFocus?.id
    ...
    : previousFocus?.hasAttribute("data-open-mastery")
      ...
      : previousFocus?.hasAttribute("data-mastery-result-all")
        ...
        : null;
  const modal = document.createElement("section"); modal.className = "mastery-modal"; modal.setAttribute("role", "dialog"); modal.setAttribute("aria-modal", "true"); modal.setAttribute("aria-labelledby", "mastery-book-title");
  modal.tabIndex = -1;
  ...
  let detail: MasteryId | null = null; let changed = false; let closed = false;
  ...
  const render = (restore?: { kind: "track"; id: MasteryId; detail: boolean } | { kind: "equip"; slot: EquipmentSlot; item: string }) => {
    ...
    const snapshot = loadMasterySnapshot(storage); const count = earnedMedalCount(snapshot.progress);
    const detailDef = detail ? MASTERY_DEFINITIONS.find(item => item.id === detail)! : null;
    modal.innerHTML = `<div class="mastery-dialog"><header><div><small>${escapeHtml(copy.personal)}</small><h2 id="mastery-book-title">${escapeHtml(copy.book)}</h2><p>${count}/8</p></div><button type="button" data-mastery-close aria-label="${escapeHtml(copy.close)}">×</button></header>${snapshot.malformed ? `<p class="mastery-state is-error" role="alert">${escapeHtml(copy.malformed)}</p>` : ""}${!snapshot.malformed && (storage as { masteryPending?: boolean }).masteryPending ? `<p class="mastery-state" role="status">${escapeHtml(copy.pending)}</p>` : ""}<div class="mastery-grid">${MASTERY_IDS.map(id => medalCard(storage, id)).join("")}</div>${detail && detailDef ? `<section class="mastery-detail" tabindex="-1" aria-labelledby="mastery-detail-title"><h3 id="mastery-detail-title">${escapeHtml(copy.names[detail])}</h3><p>${escapeHtml(copy.conditions[detail])}</p><dl><div><dt>${escapeHtml(copy.modes)}</dt><dd>${detailDef.eligibleModes.map(modeLabel).map(escapeHtml).join(" · ")}</dd></div><div><dt>${escapeHtml(copy.reward)}</dt><dd>${escapeHtml(rewardLabel(detail))}</dd></div><div><dt>${escapeHtml(copy.play)}</dt><dd>${escapeHtml(copy.tips[detail])}</dd></div></dl><div class="mastery-detail-actions"><button type="button" data-mastery-route="${detail}">${escapeHtml(copy.play)}</button><button type="button" data-mastery-track="${detail}">${escapeHtml(snapshot.preferences.tracked.medalId === detail ? copy.untrack : copy.track)}</button></div></section>` : ""}<section class="mastery-equipment"><h3>${escapeHtml(copy.rewards)}</h3><div>${ownedOptions(storage, "badge")}${ownedOptions(storage, "title")}${ownedOptions(storage, "frame")}</div>${snapshot.rewards.items["entitlement:woodgrain-set-scheduled"] ? `<p>${escapeHtml(copy.future)}</p>` : ""}</section></div>`;
    if (snapshot.malformed) for (const button of modal.querySelectorAll<HTMLButtonElement>("[data-mastery-track],[data-equip-slot]")) button.disabled = true;
    modal.querySelector("[data-mastery-close]")?.addEventListener("click", () => close());
    for (const button of modal.querySelectorAll<HTMLButtonElement>("[data-mastery-detail]")) button.onclick = () => { detail = button.dataset.masteryDetail as MasteryId; render(); modal.querySelector<HTMLElement>(".mastery-detail")?.focus(); };
    for (const button of modal.querySelectorAll<HTMLButtonElement>("[data-mastery-track]")) button.onclick = () => { const id = button.dataset.masteryTrack as MasteryId; changed = setTrackedMastery(storage, snapshot.preferences.tracked.medalId === id ? null : id) || changed; render({ kind: "track", id, detail: button.closest(".mastery-detail") !== null }); };
    for (const button of modal.querySelectorAll<HTMLButtonElement>("[data-equip-slot]")) button.onclick = () => { const slot = button.dataset.equipSlot as EquipmentSlot; const item = button.dataset.equipItem ?? ""; changed = setEquippedMastery(storage, slot, item || null) || changed; render({ kind: "equip", slot, item }); };
    modal.querySelector<HTMLButtonElement>("[data-mastery-route]")?.addEventListener("click", () => { const id = detail; close(false); if (id) onRoute(id); });
    if (restore) {
      ...
      const dialog = modal.querySelector<HTMLElement>(".mastery-dialog"); if (dialog) dialog.scrollTop = scrollTop;
    }
  };
  modal.addEventListener("pointerdown", event => { if (event.target === modal) close(); }); container.append(modal); render(); modal.querySelector<HTMLButtonElement>("[data-mastery-close]")?.focus();
  background.forEach(({ element }) => { element.inert = true; });
  document.addEventListener("keydown", trapFocus, true);
}

export function trackedMasteryText(storage: MasteryStorage): string | null {
  const snapshot = loadMasterySnapshot(storage); const id = snapshot.preferences.tracked.medalId; if (!id) return null;
  const def = MASTERY_DEFINITIONS.find(item => item.id === id)!; return `${id} ${masteryCopy().names[id]} · ${medalProgress(snapshot.progress, id)}/${def.threshold}`;
}
export function appendMasteryResult(container: HTMLElement, items: readonly MasteryProgressItem[], openAll: () => void): void {
  container.querySelector(".mastery-result-progress")?.remove(); if (!items.length) return; const copy = masteryCopy();
  container.hidden = false;
  const section = document.createElement("section"); section.className = "mastery-result-progress";
  ...
  section.querySelector("button")?.addEventListener("click", openAll); container.append(section);
}
